...
$Data_Intervalo_Periodo = date('Y-m-d', strtotime('-190 days', strtotime($Data_atual_Hoje)));

$Data_dia_Presente = date('Y-m-d ', strtotime('-24 hours', strtotime($Data_atual_Hoje)));
$Data_dia_Passado = date('Y-m-d', strtotime('-1 days', strtotime($Data_atual_Hoje)));
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
                ...
                <!--end::Header-->
					...
					<!--begin::Toolbar-->
                    <?php require_once $_SERVER['DOCUMENT_ROOT'] . '/views/toolbar.php'; ?>
					<!--end::Toolbar-->
									...
									<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100" style="background-color: #F1416C;background-image:url('assets/media/svg/shapes/wave-bg-red.svg')">
										...
										<div class="card-body d-flex align-items-end mb-3">
											...
											<div class="d-flex align-items-center">
												...
												<div class="fw-bold fs-6 text-white">
													<span class="d-block">Chamados</span>
													<span class="">em aberto - CHAMADOS DE SUPORTE EM ABERTO (7 DIAS) - STEP</span>
												</div>
											</div>
											<!--end::Info-->
										</div>
										...
										<div class="card-footer" style="border-top: 1px solid rgba(255, 255, 255, 0.3);background: rgba(0, 0, 0, 0.15);">
											...
											<div class="fw-bold text-white py-2">
												...
												<span class="opacity-50">Tickets Finalizados - CHAMADOS DE SUPORTE FECHADOS (7 DIAS) - STEP</span>
											</div>
											<!--end::Progress-->
										</div>
										<!--end::Card footer-->
									...
									<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100" style="background-color: #7239EA;background-image:url('assets/media/svg/shapes/wave-bg-purple.svg')">
										...
										<div class="card-body d-flex align-items-end mb-3">
											...
											<div class="d-flex align-items-center">
												...
												<div class="fw-bold fs-6 text-white">
													<span class="d-block">Leituras</span>
													<span class="">Registradas - LEITURAS REGISTRADAS (7 DIAS) - STEP</span>
												</div>
											</div>
											<!--end::Info-->
										</div>
										...
										<div class="card-footer" style="border-top: 1px solid rgba(255, 255, 255, 0.3);background: rgba(0, 0, 0, 0.15);">
											...
											<div class="fw-bold text-white py-2">
												...
												<span class="opacity-50">Tickets Gerados  - CHAMADOS DE SUPORTE (7 DIAS) - STEP</span>
											</div>
											<!--end::Progress-->
										</div>
										<!--end::Card footer-->
									...
									<div class="card card-flush overflow-hidden h-lg-100">
										...
										<div class="card-header pt-5">
											...
											<h3 class="card-title align-items-start flex-column">
												...
												<span class="text-gray-400 mt-1 fw-semibold fs-6">1.046 Tickets gerados Hoje</span>
											</h3>
											<!--end::Title-->
											<!--begin::Toolbar-->
								...
								<div class="col-xl-6">
									...
									<div class="card card-flush h-lg-100">
										...
										<div class="card-header pt-5">
											<!--begin::Title-->
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold text-dark">Categorias de Suporte</span>
												<span class="text-gray-400 mt-1 fw-semibold fs-6">Monitore a demanda</span>
											</h3>
											<!--end::Title-->
											<!--begin::Toolbar-->
											<div class="card-toolbar">
														...
														<div class="mb-7">
															...
															<div class="d-flex align-items-center flex-wrap d-grid gap-2">
																...
																<div class="d-flex align-items-center me-5 me-xl-13">
																	...
																	<!--begin::Info-->
																	<div class="m-0">
																		<a href="../../demo2/dist/pages/user-profile/projects.html" class="text-white text-opacity-75 fs-8">Projects</a>
																...
																<div class="d-flex align-items-center">
																	...
																	<!--begin::Info-->
																	<div class="m-0">
																		<a href="../../demo2/dist/apps/user-management/users/list.html" class="text-white text-opacity-75 fs-8">Tasks</a>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="../../demo2/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Guy Hawkins</a>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="../../demo2/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jane Cooper</a>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="../../demo2/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jacob Jones</a>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="../../demo2/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Esther Howard</a>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="../../demo2/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Ralph Edwards</a>
								...
								<div class="col-xl-4">
									...
									<div class="card card-flush h-lg-100">
										...
										<div class="card-header pt-7 mb-7">
											...
											<!--begin::Toolbar-->
											<div class="card-toolbar">
												<a href="../../demo2/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-sm btn-light">PDF Report</a>
											</div>
											<!--end::Toolbar-->
										</div>
										<!--end::Header-->
					...
					<div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_help_body" data-kt-scroll-dependencies="#kt_help_header" data-kt-scroll-offset="5px">
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="../../demo2/dist/documentation/getting-started.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Documentation &amp; Videos</a>
									<!--end::Title-->
									<!--begin::Description-->
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="../../demo2/dist/documentation/base/utilities.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Plugins &amp; Components</a>
									<!--end::Title-->
									<!--begin::Description-->
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="https://preview.keenthemes.com/metronic8/demo2/layout-builder.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Layout Builder</a>
									<!--end::Title-->
									<!--begin::Description-->
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="../../demo2/dist/documentation/getting-started/changelog.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">What's New</a>
									<!--end::Title-->
									<!--begin::Description-->
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<div id="kt_modal_users_search_handler" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="inline">
							...
							<form data-kt-search-element="form" class="w-100 position-relative mb-5" autocomplete="off">
								...
								<!--end::Icon-->
								<!--begin::Input-->
								<input type="text" class="form-control form-control-lg form-control-solid px-15" name="search" value="" placeholder="Buscar by username, full name or email..." data-kt-search-element="input" />
								<!--end::Input-->
								<!--begin::Spinner-->
