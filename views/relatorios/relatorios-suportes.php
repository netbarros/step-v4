									...
									<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
										...
										<div class="w-150px">
											...
											<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Status" data-kt-relatorio_leituras-order-filter="status">
												...
												<option value="Aguardando">Aguardando Suporte</option>
												<option value="Atendimento">Em Atendimento</option>
												<option value="Terceiros">Dependendo de Terceiros</option>
                                                <option value="Revogada">Revogação de Indicador</option>
                                                <option value="Liberada ">Liberação de Indicador</option>
										...
										<div id="relatorio_leituras_export_menu" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true">
                                            ...
                                            <!--begin::Menu item--> 
											<div class="menu-item px-3">
												<a href="javascript:;" class="menu-link px-3 gera_relatorio" data-id="tabela_relatorio_leitura" data-titulo="Suportes em Aberto">Exportar para PDF </a>
											</div>
											<!--end::Menu item-->
...
<div class="progress-bar progress-bar-striped progress-bar-animated fs-6 bg-info" style="width: 10%" ><div class="text-gray-900"></div></div>
									...
									<!--begin::Table-->
									<table class="table table-striped border rounded gy-5 gs-7" id="tabela_relatorio_leitura">
										<!--begin::Table head-->
										<thead>
											<!--begin::Table row-->
											<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
												<th class="min-w-5px mw-10px">ID</th>
                                                <th class="text-start min-w-10px">Mídia</th>
                                                <th class="text-start min-w-30px mw-50px">Status</th>
												<th class="min-w-60px mw-100px">Projeto</th>
												<th class="min-w-100px mw-100px">Núcleo</th>
												<th class="min-w-80px mw-100px">Categoria</th>
                                                <th class="min-w-150px mw-200px">Suporte</th>
                                                <th class="min-w-80px mw-100px">Usuário</th>
												<th class="text-start min-w-80px">Abertura</th>
												<th class="text-start min-w-80px mw-90px">Conclusão</th>
        ...
        <?php require '../../views/conta-usuario/atividade-usuario.php'; ?>
        <!--end::Activities drawer-->
        <!--end::Activities drawer-->
 <!--begin::Chat drawer-->
 <?php require '../../views/chat/chat-usuario.php'; ?>
   ...
   <!--end::Chat drawer-->
        ...
        <?php include_once $_SERVER['DOCUMENT_ROOT'].'/views/cockpit/modal-app-cockpit.php'; ?>
   ...
   <!--begin::Page loading(append to body)-->
        <div class="alert alert-primary d-flex align-items-center p-5 mb-10" id="edita_aguardar_modal_carregar">
            ...
            <div class="d-flex flex-column">
                ...
                <span class="spinner-border text-primary" role="status_"></span>
...
<a href="javascript:;" data-id_suporte="4134" data-id_conversa="4664" data-kt-drawer-show="true"
 data-kt-drawer-target="#drawer_Suporte" class="fs-6 text-gray-800 text-hover-warning fw-bold" 
onclick="storeDataAttributesJanelaSuporte(this)">Equipamento da Operação Danificado</a>
...
function storeDataAttributesJanelaSuporte(element) {
    ...
    console.log("armazenou as variaveis do chat ticket: "+window.id_suporte);
}
...
Modal_Imagem_leitura.addEventListener('shown.bs.modal', function (e) {
    ...
    var id_suporte    = button.data('id_suporte');  
