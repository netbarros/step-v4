...
<div class="card card-flush">
									...
									<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
										...
										<div class="w-150px">
											...
											<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Status" data-kt-ecommerce-order-filter="status">
                                                ...
                                                <option value="Impreciso">Impreciso</option>
										...
										<div id="relatorio_leituras_export_menu" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true">
											...
											<!--begin::Menu item--> 
											<div class="menu-item px-3">
												<a href="javascript:;" class="menu-link px-3 gera_relatorio" data-id="tabela_relatorio_leitura" data-titulo="Tarefas Realizadas">Exportar para PDF </a>
											</div>
											<!--end::Menu item-->
										</div>
										<!--end::Menu-->
                                ...
                                <div  class="table table-striped border rounded gy-5 gs-7" id="loader">
									...
									<table class="table table-striped border rounded gy-5 gs-7" id="tabela_relatorio_leitura">
										...
										<thead>
                                            ...
                                            <th class="text-start min-w-50px" data-priority="1">Data</th>
                                                <th class="max-w-25px">Tipo</th>
                                                <th class="max-w-25px">Modo</th>
                                                <th class="min-w-50px" data-priority="2">Usuário</th>
												<th class="min-w-100px" data-priority="3">Projeto</th>
												<th class="min-w-100px">Núcleo</th>
												<th class="min-w-100px">PLCode</th>
                                                <th class="min-w-100px">Indicador</th>
                                                <th class="min-w-100px">Hora Prevista</th>
												<th class="min-w-130px">Hora Lida</th>
                                                <th class="max-w-25px">Mídia</th>
                                                <th class="max-w-25px" data-priority="4">Status</th>
 ...
 <?php include '../../views/chat/chat-usuario.php'; ?>
  ...
  <div class="modal fade" id="kt_modal_edita_target" tabindex="-1" aria-hidden="true">
<!--begin::Modal dialog-->
...
<script>
  function loadScripts() {
    const scripts = [
      ...
      '../../js/relatorios-tarefas/relatorios.js',
      'assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js',
      '../../js/relatorios-tarefas/graficos-relatorio.js',
