									...
									<table class="table table-striped border rounded gy-5 gs-7 " id="tabela_relatorio_leitura" >
										...
										<thead>
                                            ...
                                            <th class="min-w-20px">ID</th>
												<th class="min-w-20px">Cadastro</th>
                                                <th class="text-start min-w-150px">CNPJ</th>
												<th class="min-w-150px">Razão Social</th>
												<th class="min-w-150px">Nome Fantasia</th>
												<th class="min-w-150px">E-mail Geral</th>
...
<div class="modal fade" id="kt_modal_edita_cliente" tabindex="-1" aria-hidden="true">
        ...
        <script src="../../js/relatorios-clientes/relatorios.js"></script>

        <script src="assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js"></script>

        <script src="../../js/relatorios-clientes/graficos-relatorio.js"></script>
