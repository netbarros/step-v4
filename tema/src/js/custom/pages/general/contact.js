    ...
    var initMap = function(elementId) {
        ...
        leaflet.on('click', function (e) {
            geocodeService.reverse().latlng(e.latlng).run(function (error, result) {
                ...
                // Exibir popup confirmation. For more info check the plugin's official documentation: https://sweetalert2.github.io/
                Swal.fire({
			...
			if (validator) {
				validator.validate().then(function (status) {
					...
					if (status == 'Valid') {
						...
						// Exibir error popuo. For more info check the plugin's official documentation: https://sweetalert2.github.io/
						Swal.fire({
