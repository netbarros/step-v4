...
var KTModalNewCard = function () {
	...
	var handleForm = function() {
			...
			if (validator) {
				validator.validate().then(function (status) {
					...
					if (status == 'Valid') {
						...
						// Exibir popup warning. For more info check the plugin's official documentation: https://sweetalert2.github.io/
						Swal.fire({
		...
		cancelButton.addEventListener('click', function (e) {
			...
			// Exibir success message. For more info check the plugin's official documentation: https://sweetalert2.github.io/
			Swal.fire({
