"use strict"; var KTSignupGeneral = function () {
    var e, t, a, r, s = function () { return 100 === r.getScore() }; return {
        init: function () {
            e = document.querySelector("#kt_sign_up_form"),
                ...
                a = FormValidation.formValidation(e, {
                    fields: {
                        "first-name": {
                            ...
                            validators: {
                                ...
                                }, callback: { message: "Please enter valid password", callback: function (e) { if (e.value.length > 0) return s() } }
                            }
                        }, "confirm-password": {
                            validators: {
                                notEmpty: {
                    ...
                    s.preventDefault(), a.revalidateField("password"),
                                ...
                                setTimeout((function () {
                                    t.removeAttribute("data-kt-indicator"),
                                        ...
                                        Swal.fire({
                                            ...
                                            if (t.isConfirmed) {
                                                e.reset(), r.reset();
                                                var a = e.getAttribute("data-kt-redirect-url"); a && (location.href = a)
                                            }
                                        }))
                                }), 1500)) : Swal.fire({
