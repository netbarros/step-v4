...
$Data_Intervalo_Periodo=date('Y-m-d', strtotime('-3 days', strtotime($Data_Atual_Periodo)));
$dia_tarefa_cron=date('d');
    
//  Gera Log da Leiitura fora do GPS
            $acao_log = "CRON";
            $tipo_log = '49'; // Tarefa CRON iniciada
...
//=====[ final da classe envia email]=====================<<
                ...
                if($envia_sms=='1'){
                    ...
                    if($Tel_SU!=""){ //inicia a ligação Supervisor
                        ...
                        $mensagem_alerta = limita_caracteres("Olá ".$nome_Supervisor." . ".$retorno_alerta."! \n\r Estação: ".$nome_estacao." \n\r  PLCODE: ".$nome_plcode.".
                        \n\r Operador: " . $nome_Operador . ".",160,false);
                    ...
                    if($Tel_Ro!=""){ //inicia a ligação RO
                        ...
                        $mensagem_alerta =   $mensagem_alerta = limita_caracteres("Olá ".$nome_RO." . ".$retorno_alerta."!\n\r Obra: $nome_obra \n\r Estação: ".$nome_estacao." \n\r  PLCODE: ".$nome_plcode.".
                        \n\rOperador: " . $nome_Operador . ".",160,false);
                    ...
                    if($Tel_OP!=""){ //inicia a ligação Operador
                        ...
                        $mensagem_alerta =   $mensagem_alerta = limita_caracteres("Olá ".$nome_Operador." . ".$retorno_alerta."!\n\r Estação: ".$nome_estacao." \n\r PLCODE: ".$nome_plcode.".
                ...
                if($liga=='1'){
                    ...
                    $mensagem_alerta = "Olá ".$nome_Supervisor." . ".$retorno_alerta."!  Obra: $nome_obra, Estação: ".$nome_estacao." - PLCODE: ".$nome_plcode.".
                        Suporte Gerado.";
                     ...
                     if($Tel_Ro!=""){ //inicia a ligação Supervisor
                        ...
                        $mensagem_alerta = "Olá ".$nome_RO." . ".$retorno_alerta."! Obra: $nome_obra,  Estação: ".$nome_estacao.", PLCODE: ".$nome_plcode.".
                        Suporte Gerado.";
                     ...
                     if($Tel_OP!=""){ //inicia a ligação Supervisor
                        ...
                        $mensagem_alerta = "Olá ".$nome_Operador." . ".$retorno_alerta."!  Obra: $nome_obra, Estação: ".$nome_estacao." - PLCODE: ".$nome_plcode.".
                        Suporte Gerado.";
...
$entrada = $Hora_Leitura_Agendada;
$saida =$Hora_Checkin_Realizado;
...
$tempo_decorrido = $hora_ponto.":".$min_ponto.":".$secs_ponto;
...
*/
                  ...
                  $prazo_decorrido = round($totalSecondsDiff/60, 2); //710003.75
                   $prazo_decorrido_horas =  round($totalSecondsDiff/60/60, 2);
                    ...
                    $retorno_alerta = "<br> Checkin dentro do  Prazo de 35 minutos de carência, com $tempo_decorrido  H/m de diferença.\n"; 
                    ...
                    $retorno_alerta = "<br> Checkin com diferença de $tempo_decorrido em relação ao Horário agendado: $Hora_Leitura_Agendada.\n"; 
...
//=====[ final da classe envia email]=====================<<
                ...
                if($envia_sms=='1'){
                    ...
                    if($Tel_Ro!=""){ //inicia a ligação RO
                       ...
                       $mensagem_alerta = limita_caracteres("Olá ".$nome_RO." . ".$retorno_alerta."!\n\r Obra: $nome_obra \n\r Estação: ".$nome_estacao." \n\r PLCODE: ".$nome_plcode.".
                        \n\r Operador: " . $nome_Operador . ".",160,false);
                    ...
                    if($Tel_OP!=""){ //inicia a ligação Operador
                       ...
                       $mensagem_alerta = limita_caracteres("Olá ".$nome_Operador." . ".$retorno_alerta."! Obra: $nome_obra, Estação: ".$nome_estacao." - PLCODE: ".$nome_plcode.".
                        Suporte Gerado.",160,false);
