"use strict";
// comparativo de 7 + 7 dias de leiutra
// Class definition
var KTChartsWidget27 = function () {
    ...
    // Private methods
    var initChart = function(chart_Widget27) {
        ...
        $.getJSON('../../crud/dashboard/consulta-widget-27.php?modelo_grafico=1&periodo=7', function (objects) {
            ...
            for (let obj of objects) {
                    ...
                    nome_estacao.push(obj.nome_estacao);
        ...
        chart_Widget27.self = new ApexCharts(element, options);
            chart_Widget27.self.render();
            chart_Widget27.rendered = true;
    ...
    return {
        init: function () {
            initChart(chart_Widget27);

            // Update chart on theme mode change
            KTThemeMode.on("kt.thememode.change", function() {                
                if (chart_Widget27.rendered) {
                    chart_Widget27.self.destroy();
                }
