...
var KTCustomersList = function () {
    var t, e, o, n,checkboxValue, c = () => {
        n.querySelectorAll('[data-kt-customer-table-filter="delete_row"]').forEach((e => {
            e.addEventListener("click", (function (e) {
                e.preventDefault();
                const o = e.target.closest("tr")
                    , n = o.querySelectorAll("td")[1].innerText;
                    const checkboxValue = e.target.closest("tr").querySelectorAll("td")[0].querySelector("#id_usuario").value;


                    
                Swal.fire({
                    text: "Você têm certeza que deseja Inativar:  " + n + "?",
                    icon: "warning",
                    showCancelButton: !0,
                    buttonsStyling: !1,
                    ...
                    e.value   ?  $.ajax({
                        ...
                        success: function(retorno){
                            Swal.fire({
                                text: 'A Conta de '+ n + retorno.mensagem,
                                icon: "success",
                                buttonsStyling: !1,
                                confirmButtonText: "Ok!",
                                customClass: {
        ...
        , r = () => {
            ...
            e.forEach((t => {
                ...
                o.addEventListener("click", (function () {
                    Swal.fire({
                        text: "Você têm certeza que irá inativar os Usuários Selecionados?",
                        icon: "warning",
                        showCancelButton: !0,
                        buttonsStyling: !1,
                        confirmButtonText: "Sim, Inativar!",
                        ...
                        e.value   ?  $.ajax({
                            ...
                            text: "Os Usuários Selecionados, não foram Inativados.",
                            icon: "error",
                            buttonsStyling: !1,
    ...
    return {
        init: function () {
            (n = document.querySelector("#kt_tabela_usuarios")) && (n.querySelectorAll("tbody tr").forEach((t => {
