...
WHERE  s.status_suporte!='4' AND (s.tipo_suporte='87' OR s.tipo_suporte='92' OR s.tipo_suporte='95') AND (sc.destinatario_direto = '$usuario_sessao' OR sd.id_destinatario= '$usuario_sessao')
