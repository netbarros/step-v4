...
$Data_2_6_meses = date('Y-m-d H:i:s', strtotime('-360 days', strtotime($Data_Atual_Periodo)));
...
ORDER BY total_leitura_final DESC LIMIT 0,2");
        ...
        if ($conta_2 > 0) {
            ...
            $porcentagem_total_widget_28 = (($total_leitura_final - $total_leitura_inicial) / $total_leitura_inicial) * 100;
            ...
            $dados[] = array(
                ...
                'porcentagem_total_widget_28' => round($porcentagem_total_widget_28, 2),
